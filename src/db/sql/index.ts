...
export = {
    ...
    collections: {
        create: sql('collections/create.sql'),
        empty: sql('collections/empty.sql'),
        init: sql('collections/init.sql'),
        drop: sql('collections/drop.sql'),
        add: sql('collections/add.sql'),
        find: sql('collections/find.sql'),
    },
    words: {
        create: sql('words/create.sql'),
        empty: sql('words/empty.sql'),
        init: sql('words/init.sql'),
        drop: sql('words/drop.sql'),
        add: sql('words/add.sql')
    },
    assignments: {
        create: sql('assignments/create.sql'),
        empty: sql('assignments/empty.sql'),
        init: sql('assignments/init.sql'),
        drop: sql('assignments/drop.sql'),
        add: sql('assignments/add.sql')
    },
    decks: {
        create: sql('decks/create.sql'),
        empty: sql('decks/empty.sql'),
        drop: sql('decks/drop.sql'),
        find: sql('decks/find.sql'),
        add: sql('decks/add.sql'),
        findByCollection: sql('decks/findByCollection.sql'),
        findByNameAndCollection: sql('decks/findByNameAndCollection.sql'),
        getContentById: sql('decks/getContentById.sql')
    },
    subjects: {
        create: sql('subjects/create.sql'),
        empty: sql('subjects/empty.sql'),
        drop: sql('subjects/drop.sql'),
        find: sql('subjects/find.sql'),
